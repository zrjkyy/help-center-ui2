...
$(document).ready(function(){
    $(".q-content img:not(.unzoom):not(.avatar),.post-content img:not(.unzoom):not(.avatar),.ticket-single img:not(.unzoom):not(.avatar)").each(function(i) {
        var _this = $(this);
        if (!_this.hasClass('wp-smiley')) { 
            _this.addClass("io-zoom");
        } 
    });
    mediumZoom('.io-zoom', {
        margin: 30,
        background: "rgba(25, 20, 22, .9)"
    });
});